...
process = cms.Process("EXODiLeptonOct09Skim")
...
process.load('SUSYBSMAnalysis.Skimming.EXODiLeptonOct09_EventContent_cfi')
process.load('SUSYBSMAnalysis.Skimming.EXODiLeptonOct09_cff')


#define output file name. 
process.exoticaDiLeptonOutputModule.fileName = cms.untracked.string('EXODiLeptonOct09.root')#user can define here which EventContent to save
