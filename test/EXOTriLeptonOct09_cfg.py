...
process = cms.Process("EXOTriLeptonOct09Skim")
...
process.load('SUSYBSMAnalysis.Skimming.EXOTriLeptonOct09_EventContent_cfi')
process.load('SUSYBSMAnalysis.Skimming.EXOTriLeptonOct09_cff')


#define output file name. 
process.exoticaTriLeptonOutputModule.fileName = cms.untracked.string('EXOTriLeptonOct09.root')#user can define here which EventContent to save
