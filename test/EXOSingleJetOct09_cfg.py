...
process = cms.Process("EXOSingleJetOct09Skim")
...
process.load('SUSYBSMAnalysis.Skimming.EXOSingleJetOct09_EventContent_cfi')
process.load('SUSYBSMAnalysis.Skimming.EXOSingleJetOct09_cff')


#define output file name. 
process.exoticaSingleJetOutputModule.fileName = cms.untracked.string('EXOSingleJetOct09.root')
