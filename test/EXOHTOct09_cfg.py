...
process = cms.Process("EXOHTOct09Skim")
...
process.load('SUSYBSMAnalysis.Skimming.EXOHTOct09_EventContent_cfi')
process.load('SUSYBSMAnalysis.Skimming.EXOHTOct09_cff')


#define output file name. 
process.exoticaHTOutputModule.fileName = cms.untracked.string('EXOHTOct09.root')
