...
process = cms.Process("EXOSinglePhoOct09Skim")
...
process.load('SUSYBSMAnalysis.Skimming.EXOSinglePhoOct09_EventContent_cfi')
process.load('SUSYBSMAnalysis.Skimming.EXOSinglePhoOct09_mod_cff')

#define output file name.
process.exoticaSinglePhoOutputModule.fileName = cms.untracked.string('EXOSinglePhoOct09.root')
