...
process = cms.Process("EXOEleOct09Skim")
...
process.load('SUSYBSMAnalysis.Skimming.EXOEleOct09_EventContent_cfi')
process.load('SUSYBSMAnalysis.Skimming.EXOEleOct09_cff')

#define output file name.
process.exoticaEleOutputModule.fileName = cms.untracked.string('EXOEleOct09.root')
