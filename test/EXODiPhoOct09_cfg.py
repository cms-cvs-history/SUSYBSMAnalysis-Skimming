...
process = cms.Process("EXODiPhoOct09Skim")
...
process.load('SUSYBSMAnalysis.Skimming.EXODiPhoOct09_EventContent_cfi')
process.load('SUSYBSMAnalysis.Skimming.EXODiPhoOct09_cff')


#define output file name. 
process.exoticaDiPhoOutputModule.fileName = cms.untracked.string('EXODiPhoOct09.root')
